...
(function (global) {
  ...
  const NAV_GROUPS = [
    {
      label: "总览",
      items: [{ id: "dashboard", name: "仪表盘", icon: "dashboard", href: "#" }],
    },
    {
      label: "能力",
      items: [
        { id: "memory", name: "长期记忆", icon: "memory", href: "#" },
        { id: "jargon", name: "黑话词库", icon: "jargon", href: "#" },
        { id: "examples", name: "回复样例", icon: "chat", href: "#" },
        { id: "context", name: "上下文追踪", icon: "file", href: "#" },
      ],
    },
    {
      label: "管理",
